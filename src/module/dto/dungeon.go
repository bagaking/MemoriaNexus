...
type (
	...
	DungeonMonster struct {
		...
		SourceType model.MonsterSource `json:"source_type,omitempty"`
		...
		Difficulty def.DifficultyLevel `json:"difficulty,omitempty"` // Item 向 DungeonMonster 单项同步
		Importance def.ImportanceLevel `json:"importance,omitempty"` // Item 向 DungeonMonster 单项同步
